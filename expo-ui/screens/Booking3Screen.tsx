...
interface Booking3ScreenProps {
  onGoBack?: () => void;
  onNext?: (data: { passengerType: string; equipment: string[] }) => void;
}

const Booking3Screen: React.FC<Booking3ScreenProps> = ({ onGoBack, onNext }) => {
  ...
  const handleNext = () => {
    ...
    onNext?.({ passengerType, equipment });
  };
