...
export default function Booking4Screen() {
  const router = useRouter();
  const bookingData = MOCK_BOOKING_DATA;
  ...
  const summaryItems = [
    ...
    {
      label: 'ผู้โดยสาร :',
      value: passengerTypeLabel[bookingData.passengerType || ''] || '-',
    },
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          ...
          <Text style={styles.title}>สรุปการจอง</Text>
          <Text style={styles.subtitle}>ตรวจสอบข้อมูลก่อนยืนยัน</Text>

          <View style={styles.summaryCard}>
            <Text style={styles.summaryTitle}>รายละเอียดการจอง</Text>
