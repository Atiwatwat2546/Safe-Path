...
// TODO: Connect Firebase - แทนที่ด้วย auth.currentUser และ Firestore
const MOCK_USER = {
  name: 'สมชาย ใจดี',
  username: 'somchai',
  profileImage: null as string | null, // ใส่ URL ถ้ามี
};
...
const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <BookingCard onPress={onNavigateToBooking} />
        <PromotionCarousel />
        <UpcomingBooking />
        <StatCards 
          onSettingsPress={onNavigateToSettings} 
          onHistoryPress={onNavigateToHistory} 
        />
      </ScrollView>
    </View>
  );
