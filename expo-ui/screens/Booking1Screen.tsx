...
import { View, Text, StyleSheet, TouchableOpacity, Dimensions, TextInput, FlatList, ScrollView, Alert } from 'react-native';
...
const MOCK_HOSPITALS = [
  ...
  { id: '4', name: 'โรงพยาบาลบำรุงราษฎร์', address: 'แขวงคลองเตยเหนือ เขตวัฒนา กรุงเทพฯ', lat: 13.7378, lng: 100.5596 },
  { id: '5', name: 'โรงพยาบาลสมิติเวช', address: 'แขวงสวนหลวง เขตสวนหลวง กรุงเทพฯ', lat: 13.7242, lng: 100.6436 },
];
...
const Booking1Screen: React.FC<Booking1ScreenProps> = ({ onGoBack, onNext }) => {
  ...
  const handleNext = () => {
    ...
    // TODO: Connect Firebase - บันทึกข้อมูลการจอง
    onNext?.({
      fromAddress,
      toAddress,
      fromLocation,
